 ...
 * It also clears the current drawing using the default background color
 * (white).
 * Ordinarily, this method is called only once, at the very beginning of a
 * program.
 ...
 * The image must be in a supported file format (typically JPEG, PNG, GIF, TIFF,
 * and BMP).
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * @throws IllegalArgumentException if {@code filename} has invalid filetype
     *                                  extension
    ...
    public static void save(String filename) {
        ...
        if (!filename.contains(".") || suffix.length() == 0) {
            throw new IllegalArgumentException(
                    "The filename '" + filename + "' has no filetype extension, such as .jpg or .png");
        }
