...
//             obstacles.add(new CoralObstacle(1.2f, y, width, height, speed, type, tex));
//             System.out.println("Obstacles count: " + obstacles.size());
...
//         for (CoralObstacle obstacle : obstacles) {
//             if (obstacle.collidesWith(subX, subY, subW, subH)) {
//                 System.out.println("COLLISION with type: " + obstacle.getType());
//                 return obstacle.getType(); // 0 = coral, 1 = trash
//             }
//         }
//         return 0;
//     }

//     public List<CoralObstacle> getObstacles() {
//         return obstacles;
//     }
// }

// CoralManager.java (cleaned up, old collision style)
package maze;
...
public class CoralManager {
    ...
    private static final float SPAWN_INTERVAL = 2f;
    private static final float MIN_SAFE_GAP = 0.6f;
    private static final int MAX_OBSTACLES = 3;
