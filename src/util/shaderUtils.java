...
public class shaderUtils {
    ...
    public static int load(String vertPath, String fragPath){  
        //used since we create shaders from files and not from strings, acts as the bridge between fileUtils and here 
        String vert = fileUtils.load_as_string(vertPath);
        String frag = fileUtils.load_as_string(fragPath);
        return create(vert, frag);
    }

    public static int create(String vert, String frag){ //will create a program containing our two shaders based on string from src code
